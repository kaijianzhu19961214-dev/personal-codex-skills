...
metadata:
  source: https://github.com/zilliztech/memsearch/tree/main/plugins/codex/skills/memory-to-skill
...
中文说明：这个 skill 用于把 MemSearch 里的重复工作流提炼成候选 skill。候选文件默认在 `.memsearch/skill-candidates/`，不会自动安装；安装到个人 Codex skills 仓库前必须先让用户确认目标路径和内容。
